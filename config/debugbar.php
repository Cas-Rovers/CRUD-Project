<?php
    ...
    return [
        ...
        /*
         ...
         | You can override the value by setting enable to true or false1 instead of null.
         |
         | You can provide an array of URI's that must be ignored (for example, 'api/*')
         |
         */
        ...
        /*
         ...
         | request, don't enable open storage in publicly available environments!
        ...
        'storage' => [
            ...
            'provider' => '', // Instance of StorageInterface for a custom driver
            'hostname' => '127.0.0.1', // Hostname to use with the "socket" driver
            'port' => 2304, // Port to use it with the "socket" driver
        ],
        ...
        |--------------------------------------------------------------------------
        |
        | Choose your preferred editor to use when clicking filename.
        |
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | If you're using a remote dev server, like Laravel Homestead, Docker, or
        ...
        */
        ...
        'options' => [
            ...
            'auth' => [
                'show_name' => true,   // Also show the user's name/email in the debugbar
                'show_guards' => true, // Show the guards that are used
            ],
            'db' => [
                'with_params' => true,   // Render SQL with the parameters substituted
                'exclude_paths' => [       // Paths to exclude entirely from the collector
//                'vendor/laravel/framework/src/Illuminate/Session', // Exclude session queries
                ],
            ...
            'views' => [
                ...
                'group' => 50,          // Group duplicate views. Pass value to an auto-group, or true/false to force
