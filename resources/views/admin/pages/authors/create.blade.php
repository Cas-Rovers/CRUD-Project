...
@section('content')
    <h2 class="text-2xl font-semibold mb-4 dark:text-white text-center">{{ __('admin/authors.create.title') }}</h2>
    <form action="{{ route('admin.authors.store') }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <x-admin.form.input name="first_name" type="text" autocomplete="name" required/>
        </div>
        ...
        <div class="mb-6">
            ...
            <x-admin.form.input name="last_name" type="text" autocomplete="name" required/>
        </div>
